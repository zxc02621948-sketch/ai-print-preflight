...
- 顯示「適合印多大」：
  ...
  - 150 DPI 一般海報
  - 72 DPI 遠距看板
- 依用途顯示處理順序建議，例如先分層、先放大，或判斷是否需要向量化
- 依處理順序列出多個修復建議，不只推薦單一步驟
- 可標記 Logo / 圖示 / 徽章素材，說明多數情境可先用高解析 PNG/PDF，只有超大輸出、改色拆物件或店家要求時再考慮向量化
- SVG / PDF / AI 不進入評分流程，建議使用向量軟體或交由印刷店做交付檢查
- 提供「我想轉向量 / SVG 教學」進階彈窗，整理 Inkscape Trace Bitmap 的下載、描圖、清理與交付流程
